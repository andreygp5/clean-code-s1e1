...
var taskInput=document.getElementById("add-form__input");//Add a new task.
...
var createNewTaskElement=function(taskString){
    ...
    label.className='item__name task';
    ...
    deleteButtonImg.className = "item__delete-img";
...
var editTask=function(){
    ...
    //If class of the parent is .item_edit
    if(containsClass){
    ...
    //toggle .item_edit on the parent.
...
//select ListItems children
    ...
    var editButton=taskListItem.querySelector("button.item__edit-btn");
    var deleteButton=taskListItem.querySelector("button.item__delete-btn");
